        ...
        <div class="row carrer-formbox">
            ...
            <div class="col-lg-6">
                ...
                <p class="m_hide">Fill in the details and submit we will connect with you</p>
                    <input type="submit" class="form-control text-capitalize form-submit-custom carrer-submit" value="SUBMIT">
                </div>
...
<script>
// Add the following code if you want the name of the file appear on select BROWSE 
